...
from constants import bot,allowed_guilds
...
def setup(bot_setup):
    bot_setup.add_command(random_waifu)
    bot_setup.add_command(waifu_from_number)
    bot_setup.add_command(random_waifu_from_user)
    bot_setup.add_command(pull_waifu)
    bot_setup.add_command(waifudex)
    bot_setup.add_command(essence_shop)
    bot_setup.add_command(waifu_from_rank)
    bot_setup.add_command(trade)
