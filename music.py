...
from constants import allowed_guilds, bot
...
def setup(bot_setup):
    bot_setup.add_command(play)
    bot_setup.add_command(clear_queue)
    bot_setup.add_command(pause)
    bot_setup.add_command(stop)
    bot_setup.add_command(queue)
